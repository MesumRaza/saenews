...
def quote(title,tag_line,input_file, output_file='', cord = (0.035,0.666), font_size='', caption_width='', border_width='' , logo_border='', border_color='red', text_font = '', cap_text_font = '', font_size=='', cap_width=0.055):
    repo_path = get_path()
    ...
    ## For the Title
    xy = (round(W*cord[0]),round(H*cord[1]))
    if text_font == '':
        text_font=repo_path + '/fonts/OTF/Akrobat-Black.otf'
    if font_size == '':
        font_size = W//25 # Font Size Enter Manually if required
